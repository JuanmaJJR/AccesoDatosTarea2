...
public class VistaActualizar extends JFrame {
	 ...
	 * @param jugadoresfin 
	 */
	public VistaActualizar(int iddel, ArrayList<Jugador> jugadoresfin) {
		...
		JLabel lblAadirJugador = new JLabel("Actualizar Jugador");
		lblAadirJugador.setFont(new Font("Sylfaen", Font.BOLD, 30));
		lblAadirJugador.setBounds(47, 19, 283, 40);
		...
		JButton btnAadirJugador = new JButton("Actualizar jugador");
		btnAadirJugador.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				controlador.actualizarDatos(iddel,txtNombre.getText(),txtApellido.getText(),txtPosicion.getText(),txtEquipo.getSelectedItem().toString());
			}
		});
		...
		JLabel lblAadirEquipo = new JLabel("Actualizar Equipo");
		lblAadirEquipo.setBounds(90, 17, 286, 40);
		...
		JButton btnAadirEquipo = new JButton("Actualizar equipo");
		...
		btnAadirEquipo.setBounds(145, 410, 120, 23);
		panel_1.add(btnAadirEquipo);
		
		//txtNombre.getText(),txtApellido.getText(),txtPosicion.getText(),txtEquipo.getSelectedItem().toString()
		for (int i = 0; i < jugadoresfin.size(); i++) {
			if(iddel==jugadoresfin.get(i).getID()) {
				txtNombre.setText(jugadoresfin.get(i).getNombre());
				txtApellido.setText(jugadoresfin.get(i).getApellido());
				txtPosicion.setText(jugadoresfin.get(i).getPosicion());
			}
			//txtEquipo.addItem(jugadoresfin.get(i).getEquipo().getNombre());
		}
	}
